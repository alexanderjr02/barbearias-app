  ...
  Widget _profileTab(AppPalette palette, Color accent) {
    ...
    return ListView(
      ...
      children: [
        ...
        const FieldLabel('Produtos de finalização'),
        TagListField(
          controller: _produtosCtrl,
          hint: 'Digite e confirme',
          suggestions: const ['Sem produto', 'Pomada matte', 'Pomada brilho', 'Cera', 'Gel', 'Bálsamo', 'Talco'],
        ),
        Padding(
        ...
        const FieldLabel('Bebidas oferecidas'),
        TagListField(
          controller: _bebidasCtrl,
          hint: 'Digite e confirme',
          suggestions: const ['Água', 'Café', 'Refrigerante', 'Cerveja', 'Energético', 'Whisky', 'Suco'],
        ),
        Padding(
          padding: const EdgeInsets.only(top: 8, bottom: 4),
          child: Text('Sem nada aqui, a pergunta de bebida não aparece pro cliente.', style: TextStyle(color: palette.textFaint, fontSize: 11.5)),
        ),
